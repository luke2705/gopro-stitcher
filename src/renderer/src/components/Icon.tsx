...
const PATHS: Record<string, string> = {
  ...
  hd: 'M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-8 12H9.5v-2h-2v2H6V9h1.5v2.5h2V9H11v6zm7-1c0 .55-.45 1-1 1h-3.5V9H17c.55 0 1 .45 1 1v4zm-3-.5h1.5v-3H15v3z',
  minimize: 'M19 13H5v-2h14v2z',
  maximize: 'M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V7h14v12z',
}
...
export default function Icon({ name, size = 20, style, className }: IconProps): React.ReactElement {
  const d = PATHS[name] || ''
  return (
    <svg
      viewBox="0 0 24 24"
